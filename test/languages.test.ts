...
describe('tier-1 language coverage', () => {
  ...
  it.each([
    ...
    ['kotlin class method', 'sym:Repository.findById'],
    ['kotlin top-level function', 'sym:fn:topLevelHelper'],
    ['kotlin const val', 'sym:const:MAX_RESULTS'],
    ['kotlin typealias', 'sym:type:RowMapper'],
    ['kotlin object', 'sym:class:ConnectionPool'],
    ['kotlin object method', 'sym:ConnectionPool.acquire'],
    ['kotlin enum class', 'sym:type:Status'],
    ['bash function', 'sym:fn:package_artifacts'],
    ['bash function-keyword form', 'sym:fn:publish_release'],
    ['bash variable', 'sym:const:RELEASE_CHANNEL'],
    ['scala object method', 'sym:Pipeline.run'],
    ['scala class', 'sym:class:Stage'],
    ['scala trait', 'sym:type:Retryable'],
    ['scala case class', 'sym:class:Event'],
    ['elixir module function', 'sym:Broker.publish'],
    ['elixir private function', 'sym:fn:validate'],
    ['elixir nested module function', 'sym:Consumer.poll'],
